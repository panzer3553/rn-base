...
public class CustomImageManagerModule extends ReactContextBaseJavaModule {
  ...
  public CustomImageManagerModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
   ...
   */
  @ReactMethod
  public void getImages(final ReadableMap params, final Promise promise) {
  ...
  private static boolean putImageInfo(
    ...
    image.putString("base64", encodeBase64(photoUri.toString()));
  ...
  public static String encodeBase64(final String absoluteFilePath)
  {
